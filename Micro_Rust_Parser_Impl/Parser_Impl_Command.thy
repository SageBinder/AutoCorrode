...
\<open>conformance\<close>, \<open>timing_info\<close>, \<open>pp_test\<close>, \<open>pretty\<close>,
\<open>application_def\<close>, and \<open>abbrev\<close>, integers \<open>verbosity\<close> and
\<open>timing_verbosity\<close>, and attribute-list \<open>attrs\<close>. The configuration-backed short names are
...
\<open>[conformance]\<close>, \<open>[timing_info]\<close>, \<open>[pp_test]\<close>, \<open>[pretty]\<close>,
\<open>[application_def]\<close>, and \<open>[abbrev]\<close>. Explicit
