...
urust_expr [abbrev] evaluate_lt_literal_expr1
  (c, d)
  \<open> c < d \<close>

urust_expr [abbrev] evaluate_lt_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_gt_literal_expr1
  (c, d)
  \<open> c > d \<close>

urust_expr [abbrev] evaluate_gt_literal_expr2
  (c, d)
  \<open> \<llangle>c > d\<rrangle> \<close>
...
urust_expr [abbrev] evaluate_ge_literal_expr1
  (c, d)
  \<open> c >= d \<close>

urust_expr [abbrev] evaluate_ge_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_le_literal_expr1
  (c, d)
  \<open> c <= d \<close>

urust_expr [abbrev] evaluate_le_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_word_bitwise_or_literal_expr1
  (c, d)
  \<open> c | d \<close>

urust_expr [abbrev] evaluate_word_bitwise_or_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_word_bitwise_xor_literal_expr1
  (c, d)
  \<open> c ^ d \<close>

urust_expr [abbrev] evaluate_word_bitwise_xor_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_word_bitwise_and_literal_expr1
  (c, d)
  \<open> c & d \<close>

urust_expr [abbrev] evaluate_word_bitwise_and_literal_expr2
  (c, d)
...
urust_expr [abbrev] evaluate_word_bitwise_not_literal_expr1 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (d)
  \<open> !d \<close>

urust_expr [abbrev] evaluate_word_bitwise_not_literal_expr2
  (d)
...
urust_expr [abbrev] evaluate_word_shift_left_literal_expr1
  (c, d)
  \<open> c << d \<close>

urust_expr [abbrev] evaluate_word_shift_left_literal_expr2
  (d, c)
...
urust_expr [abbrev] evaluate_word_shift_right_literal_expr1
  (c, d)
  \<open> c >> d \<close>

urust_expr [abbrev] evaluate_word_shift_right_literal_expr2
  (d, c)
