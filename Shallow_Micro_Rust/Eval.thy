...
urust expr [urust_abbrev = true] Eval_urust_site_1 (x, y) \<open> x + y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_2 (x, y) \<open> x + y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_3 (x, y) \<open> x + y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_4 (x, y) \<open> x + y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_5 (x, y) \<open> x + y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_6 (x, y) \<open> x + y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_7 (x, y) \<open> x * y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_8 (x, y) \<open> x * y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_9 (x, y) \<open> x * y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_10 (x, y) \<open> x * y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_11 (x, y) \<open> x * y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_12 (x, y) \<open> x * y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_13 (x, y) \<open> x - y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_14 (x, y) \<open> x - y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_15 (x, y) \<open> x - y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_16 (x, y) \<open> x - y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_17 (x, y) \<open> x - y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_18 (x, y) \<open> x - y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_19 (x, y) \<open> x / y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_20 (x, y) \<open> x / y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_21 (x, y) \<open> x / y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_22 (x, y) \<open> x / y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_23 (x, y) \<open> x / y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_24 (x, y) \<open> x / y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_25 (x, y) \<open> x % y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_26 (x, y) \<open> x % y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_27 (x, y) \<open> x % y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_28 (x, y) \<open> x % y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_29 (x, y) \<open> x % y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_30 (x, y) \<open> x % y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_31 (x, y) \<open> x << y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_32 (x, y) \<open> x << y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_33 (x, y) \<open> x << y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_34 (x, y) \<open> x << y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_35 (x, y) \<open> x << y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_36 (x, y) \<open> x << y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_37 (x, y) \<open> x >> y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_38 (x, y) \<open> x >> y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_39 (x, y) \<open> x >> y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_40 (x, y) \<open> x >> y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_41 (x, y) \<open> x >> y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_42 (x, y) \<open> x >> y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_43 (x, y) \<open> x ^ y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_44 (x, y) \<open> x ^ y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_45 (x, y) \<open> x ^ y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_46 (x, y) \<open> x ^ y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_47 (x, y) \<open> x ^ y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_48 (x, y) \<open> x ^ y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_49 (x, y) \<open> x | y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_50 (x, y) \<open> x | y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_51 (x, y) \<open> x | y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_52 (x, y) \<open> x | y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_53 (x, y) \<open> x | y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_54 (x, y) \<open> x | y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_55 (x, y) \<open> x & y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_56 (x, y) \<open> x & y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_57 (x, y) \<open> x & y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_58 (x, y) \<open> x & y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_59 (x, y) \<open> x & y \<close>
urust expr [urust_abbrev = true] Eval_urust_site_60 (x, y) \<open> x & y \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_61 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>

urust expr [urust_abbrev = true] Eval_urust_site_62 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>

urust expr [urust_abbrev = true] Eval_urust_site_63 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>
...
urust expr [urust_abbrev = true] Eval_urust_site_64 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>

urust expr [urust_abbrev = true] Eval_urust_site_65 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>

urust expr [urust_abbrev = true] Eval_urust_site_66 ::
  \<open>'l::len word \<Rightarrow> ('s, 'l word, 'r, 'abort, 'i, 'o) expression\<close>
  (x)
  \<open> !x \<close>
